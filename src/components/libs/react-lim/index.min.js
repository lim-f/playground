...
g.isPipelinePrimaryTopicReference = p0;
...
g.isTSModuleBlock = fg;
g.isTSModuleDeclaration = pg;
...
pr.isKeyword = Fb;
pr.isReservedWord = ku;
pr.isStrictBindOnlyReservedWord = Lu;
pr.isStrictBindReservedWord = Bb;
pr.isStrictReservedWord = Du;
const Wn = {
...
for (; ; ) {
  ...
  } else h === 8232 || h === 8233 ? (++r, ++s, i = r) : h === 10 || h === 13 ? e === "template" ? (u += t.slice(p, r) + `
`, ++r, h === 13 && t.charCodeAt(r) === 10 && ++r, ++s, p = i = r) : n.unterminated(a, o, l) : ++r;
}
return {
  pos: r,
  str: u,
...
`);
  ...
  default:
    if (l >= 48 && l <= 55) {
      const u = t - 1;
      let p = /^[0-7]+/.exec(e.slice(u, t + 2))[0], f = parseInt(p, 8);
...
const c = t, p = s === 16 ? to.hex : to.decBinOct, f = s === 16 ? wi.hex : s === 10 ? wi.dec : s === 8 ? wi.oct : wi.bin;
let h = !1, y = 0;
for (let b = 0, A = n ?? 1 / 0; b < A; ++b) {
  ...
  if (I === 95 && o !== "bail") {
    ...
    if (o) {
      if (Number.isNaN(G) || !f(G) || p.has(j) || p.has(G)) {
        if (u) return {
          n: null,
          pos: t
        };
...
ct.classMethodOrPropertyCommon = p;
const f = () => Object.assign({}, o(), p(), {
  params: {
...
return ct.classMethodOrDeclareMethodCommon = f, a("ClassMethod", {
  aliases: ["Function", "Scopable", "BlockParent", "FunctionParent", "Method"],
  builder: ["kind", "key", "params", "body", "computed", "static", "generator", "async"],
  visitor: ["key", "params", "body", "decorators", "returnType", "typeParameters"],
  fields: Object.assign({}, f(), l(), {
    body: {
      validate: (0, n.assertNodeType)("BlockStatement")
    }
  })
...
return i("TSAsExpression", f), i("TSSatisfiesExpression", f), i("TSTypeAssertion", {
  aliases: ["Expression", "LVal", "PatternLike"],
...
bo = 1, Object.defineProperty(T, "__esModule", {
  value: !0
}), T.anyTypeAnnotation = wp, T.argumentPlaceholder = sh, T.arrayExpression = r, T.arrayPattern = ve, T.arrayTypeAnnotation = Op, T.arrowFunctionExpression = Re, T.assignmentExpression = i, T.assignmentPattern = Be, T.awaitExpression = mt, T.bigIntLiteral = Ti, T.binaryExpression = s, T.bindExpression = nh, T.blockStatement = l, T.booleanLiteral = U, T.booleanLiteralTypeAnnotation = _p, T.booleanTypeAnnotation = Np, T.breakStatement = u, T.callExpression = c, T.catchClause = p, T.classAccessorProperty = yr, T.classBody = lt, T.classDeclaration = J, T.classExpression = He, T.classImplements = Dp, T.classMethod = Ve, T.classPrivateMethod = Si, T.classPrivateProperty = bi, T.classProperty = Ot, T.conditionalExpression = f, T.continueStatement = h, T.debuggerStatement = y, T.decimalLiteral = fh, T.declareClass = Lp, T.declareExportAllDeclaration = Kp, T.declareExportDeclaration = Vp, T.declareFunction = Mp, T.declareInterface = Bp, T.declareModule = Fp, T.declareModuleExports = jp, T.declareOpaqueType = Up, T.declareTypeAlias = Rp, T.declareVariable = $p, T.declaredPredicate = qp, T.decorator = oh, T.directive = a, T.directiveLiteral = o, T.doExpression = lh, T.doWhileStatement = b, T.emptyStatement = A, T.emptyTypeAnnotation = tf, T.enumBooleanBody = Nf, T.enumBooleanMember = Lf, T.enumDeclaration = Of, T.enumDefaultedMember = Ff, T.enumNumberBody = _f, T.enumNumberMember = Mf, T.enumStringBody = kf, T.enumStringMember = Bf, T.enumSymbolBody = Df, T.existsTypeAnnotation = Wp, T.exportAllDeclaration = d, T.exportDefaultDeclaration = x, T.exportDefaultSpecifier = uh, T.exportNamedDeclaration = O, T.exportNamespaceSpecifier = $s, T.exportSpecifier = M, T.expressionStatement = I, T.file = _, T.forInStatement = j, T.forOfStatement = Z, T.forStatement = G, T.functionDeclaration = ce, T.functionExpression = te, T.functionTypeAnnotation = Jp, T.functionTypeParam = Xp, T.genericTypeAnnotation = Yp, T.identifier = ae, T.ifStatement = q, T.import = Cr, T.importAttribute = ah, T.importDeclaration = ee, T.importDefaultSpecifier = ge, T.importExpression = X, T.importNamespaceSpecifier = xe, T.importSpecifier = ye, T.indexedAccessType = jf, T.inferredPredicate = Hp, T.interfaceDeclaration = zp, T.interfaceExtends = Gp, T.interfaceTypeAnnotation = Qp, T.interpreterDirective = n, T.intersectionTypeAnnotation = Zp, T.jSXAttribute = T.jsxAttribute = Uf, T.jSXClosingElement = T.jsxClosingElement = $f, T.jSXClosingFragment = T.jsxClosingFragment = eh, T.jSXElement = T.jsxElement = Vf, T.jSXEmptyExpression = T.jsxEmptyExpression = Kf, T.jSXExpressionContainer = T.jsxExpressionContainer = qf, T.jSXFragment = T.jsxFragment = Qf, T.jSXIdentifier = T.jsxIdentifier = Jf, T.jSXMemberExpression = T.jsxMemberExpression = Xf, T.jSXNamespacedName = T.jsxNamespacedName = Yf, T.jSXOpeningElement = T.jsxOpeningElement = Hf, T.jSXOpeningFragment = T.jsxOpeningFragment = Zf, T.jSXSpreadAttribute = T.jsxSpreadAttribute = Gf, T.jSXSpreadChild = T.jsxSpreadChild = Wf, T.jSXText = T.jsxText = zf, T.labeledStatement = Y, T.logicalExpression = k, T.memberExpression = F, T.metaProperty = rt, T.mixedTypeAnnotation = ef, T.moduleExpression = hh, T.newExpression = B, T.noop = th, T.nullLiteral = Q, T.nullLiteralTypeAnnotation = kp, T.nullableTypeAnnotation = rf, T.numberLiteral = Od, T.numberLiteralTypeAnnotation = sf, T.numberTypeAnnotation = nf, T.numericLiteral = W, T.objectExpression = D, T.objectMethod = R, T.objectPattern = We, T.objectProperty = V, T.objectTypeAnnotation = af, T.objectTypeCallProperty = lf, T.objectTypeIndexer = uf, T.objectTypeInternalSlot = of, T.objectTypeProperty = cf, T.objectTypeSpreadProperty = pf, T.opaqueType = ff, T.optionalCallExpression = Ir, T.optionalIndexedAccessType = Rf, T.optionalMemberExpression = gi, T.parenthesizedExpression = oe, T.pipelineBareFunction = yh, T.pipelinePrimaryTopicReference = Th, T.pipelineTopicExpression = mh, T.placeholder = rh, T.privateName = Ei, T.program = N, T.qualifiedTypeIdentifier = hf, T.recordExpression = ch, T.regExpLiteral = L, T.regexLiteral = Nd, T.restElement = $, T.restProperty = _d, T.returnStatement = H, T.sequenceExpression = se, T.spreadElement = it, T.spreadProperty = kd, T.staticBlock = Ip, T.stringLiteral = re, T.stringLiteralTypeAnnotation = df, T.stringTypeAnnotation = mf, T.super = dt, T.switchCase = Ue, T.switchStatement = pe, T.symbolTypeAnnotation = yf, T.taggedTemplateExpression = v, T.templateElement = he, T.templateLiteral = Fe, T.thisExpression = fe, T.thisTypeAnnotation = Tf, T.throwStatement = Se, T.topicReference = dh, T.tryStatement = Ce, T.tSAnyKeyword = T.tsAnyKeyword = Ih, T.tSArrayType = T.tsArrayType = Xh, T.tSAsExpression = T.tsAsExpression = fd, T.tSBigIntKeyword = T.tsBigIntKeyword = Oh, T.tSBooleanKeyword = T.tsBooleanKeyword = wh, T.tSCallSignatureDeclaration = T.tsCallSignatureDeclaration = Ph, T.tSConditionalType = T.tsConditionalType = ed, T.tSConstructSignatureDeclaration = T.tsConstructSignatureDeclaration = xh, T.tSConstructorType = T.tsConstructorType = Vh, T.tSDeclareFunction = T.tsDeclareFunction = bh, T.tSDeclareMethod = T.tsDeclareMethod = Sh, T.tSEnumDeclaration = T.tsEnumDeclaration = md, T.tSEnumMember = T.tsEnumMember = yd, T.tSExportAssignment = T.tsExportAssignment = xd, T.tSExpressionWithTypeArguments = T.tsExpressionWithTypeArguments = od, T.tSExternalModuleReference = T.tsExternalModuleReference = Ed, T.tSFunctionType = T.tsFunctionType = $h, T.tSImportEqualsDeclaration = T.tsImportEqualsDeclaration = Sd, T.tSImportType = T.tsImportType = bd, T.tSIndexSignature = T.tsIndexSignature = Ch, T.tSIndexedAccessType = T.tsIndexedAccessType = sd, T.tSInferType = T.tsInferType = td, T.tSInstantiationExpression = T.tsInstantiationExpression = pd, T.tSInterfaceBody = T.tsInterfaceBody = ud, T.tSInterfaceDeclaration = T.tsInterfaceDeclaration = ld, T.tSIntersectionType = T.tsIntersectionType = Zh, T.tSIntrinsicKeyword = T.tsIntrinsicKeyword = Nh, T.tSLiteralType = T.tsLiteralType = ad, T.tSMappedType = T.tsMappedType = nd, T.tSMethodSignature = T.tsMethodSignature = Ah, T.tSModuleBlock = T.tsModuleBlock = gd, T.tSModuleDeclaration = T.tsModuleDeclaration = Td, T.tSNamedTupleMember = T.tsNamedTupleMember = zh, T.tSNamespaceExportDeclaration = T.tsNamespaceExportDeclaration = vd, T.tSNeverKeyword = T.tsNeverKeyword = _h, T.tSNonNullExpression = T.tsNonNullExpression = Pd, T.tSNullKeyword = T.tsNullKeyword = kh, T.tSNumberKeyword = T.tsNumberKeyword = Dh, T.tSObjectKeyword = T.tsObjectKeyword = Lh, T.tSOptionalType = T.tsOptionalType = Hh, T.tSParameterProperty = T.tsParameterProperty = gh, T.tSParenthesizedType = T.tsParenthesizedType = rd, T.tSPropertySignature = T.tsPropertySignature = vh, T.tSQualifiedName = T.tsQualifiedName = Eh, T.tSRestType = T.tsRestType = Gh, T.tSSatisfiesExpression = T.tsSatisfiesExpression = hd, T.tSStringKeyword = T.tsStringKeyword = Mh, T.tSSymbolKeyword = T.tsSymbolKeyword = Bh, T.tSThisType = T.tsThisType = Uh, T.tSTupleType = T.tsTupleType = Yh, T.tSTypeAliasDeclaration = T.tsTypeAliasDeclaration = cd, T.tSTypeAnnotation = T.tsTypeAnnotation = Ad, T.tSTypeAssertion = T.tsTypeAssertion = dd, T.tSTypeLiteral = T.tsTypeLiteral = Jh, T.tSTypeOperator = T.tsTypeOperator = id, T.tSTypeParameter = T.tsTypeParameter = wd, T.tSTypeParameterDeclaration = T.tsTypeParameterDeclaration = Id, T.tSTypeParameterInstantiation = T.tsTypeParameterInstantiation = Cd, T.tSTypePredicate = T.tsTypePredicate = qh, T.tSTypeQuery = T.tsTypeQuery = Wh, T.tSTypeReference = T.tsTypeReference = Kh, T.tSUndefinedKeyword = T.tsUndefinedKeyword = Fh, T.tSUnionType = T.tsUnionType = Qh, T.tSUnknownKeyword = T.tsUnknownKeyword = jh, T.tSVoidKeyword = T.tsVoidKeyword = Rh, T.tupleExpression = ph, T.tupleTypeAnnotation = gf, T.typeAlias = Sf, T.typeAnnotation = Ef, T.typeCastExpression = Pf, T.typeParameter = xf, T.typeParameterDeclaration = vf, T.typeParameterInstantiation = Af, T.typeofTypeAnnotation = bf, T.unaryExpression = Ee, T.unionTypeAnnotation = Cf, T.updateExpression = Ne, T.v8IntrinsicIdentifier = ih, T.variableDeclaration = _e, T.variableDeclarator = qe, T.variance = If, T.voidTypeAnnotation = wf, T.whileStatement = tt, T.withStatement = Pe, T.yieldExpression = bt;
var e = rS(), t = Pr;
function r(m = []) {
  return (0, e.default)({
...
function Lp(m, C = null, K = null, ue) {
  return (0, e.default)({
    type: "DeclareClass",
    id: m,
    typeParameters: C,
...
function Bp(m, C = null, K = null, ue) {
  return (0, e.default)({
...
function Vp(m = null, C = null, K = null) {
  return (0, e.default)({
...
function Jp(m = null, C, K = null, ue) {
  return (0, e.default)({
...
function zp(m, C = null, K = null, ue) {
  return (0, e.default)({
...
function uf(m = null, C, K, ue = null) {
  return (0, e.default)({
...
function xf(m = null, C = null, K = null) {
  return (0, e.default)({
    type: "TypeParameter",
    bound: m,
    default: C,
...
function Vf(m, C = null, K, ue = null) {
  return (0, e.default)({
    type: "JSXElement",
    openingElement: m,
    closingElement: C,
...
function r(i, s) {
  ...
  let o = "";
  for (let l = 0; l < n.length; l++) {
    const u = n[l], c = l === 0, p = l === n.length - 1, f = l === a;
    let h = u.replace(/\t/g, " ");
    c || (h = h.replace(/^[ ]+/, "")), p || (h = h.replace(/[ ]+$/, "")), h && (f || (h += " "), o += h);
  }
...
S.assertClassDeclaration = fE;
S.assertClassExpression = pE;
...
S.assertInferredPredicate = pP;
S.assertInterfaceDeclaration = hP;
S.assertInterfaceExtends = fP;
...
var p1 = oi;
function f1(e, t) {
(0, p1.default)("trailingComments", e, t);
}
Object.defineProperty(ds, "__esModule", {
value: !0
});
ds.default = y1;
var h1 = ms, d1 = hs, m1 = fs;
function y1(e, t) {
...
function n(a, o) {
  ...
  for (const c of a)
    if ((0, t.isEmptyStatement)(c) || (u = !1), (0, t.isExpression)(c))
      ...
      const p = c.consequent ? n([c.consequent], o) : (0, i.buildUndefinedNode)(), f = c.alternate ? n([c.alternate], o) : (0, i.buildUndefinedNode)();
      if (!p || !f) return;
      l.push((0, r.conditionalExpression)(c.test, p, f));
...
return Wo || (Wo = 1, function(e) {
  ...
  var h = Kt, y = Hn, b = Gn, A = zn, I = Qn, _ = Zn, j = ps, G = fs, ce = hs, te = ds, ae = ms, q = ea, Y = z;
  ...
  var V = R1(), $ = ia, H = V1(), se = Ss, oe = gs, Ue = cs, pe = xr, fe = Es, Se = na;
  ...
  var Ce = bs, Ee = ei, Ne = ri(), _e = aa, qe = oa, tt = la, Pe = Ps, Be = us, ve = ua, Re = Iu(), lt = ca, He = pa, J = fa, d = Kn(), x = ha, O = cr, M = da, Z = os, ee = Jn(), ge = as, xe = g;
...
function r(c) {
  ...
  function b(...A) {
    if (!b.enabled)
      return;
    const I = b, _ = Number(/* @__PURE__ */ new Date()), j = _ - (p || _);
    I.diff = j, I.prev = p, I.curr = _, p = _, A[0] = r.coerce(A[0]), typeof A[0] != "string" && A.unshift("%O");
    let G = 0;
  ...
  return b.namespace = c, b.useColors = r.useColors(), b.color = r.selectColor(c), b.extend = i, b.destroy = r.destroy, Object.defineProperty(b, "enabled", {
    enumerable: !0,
    configurable: !1,
    get: () => f !== null ? f : (h !== r.namespaces && (h = r.namespaces, y = r.enabled(c)), y),
    set: (A) => {
      f = A;
    }
...
function i(c, p) {
  const f = r(this.namespace + (typeof p > "u" ? ":" : p) + c);
  return f.log = this.log, f;
}
function s(c) {
  r.save(c), r.namespaces = c, r.names = [], r.skips = [];
  let p;
  const f = (typeof c == "string" ? c : "").split(/[\s,]+/), h = f.length;
  for (p = 0; p < h; p++)
...
if (e.isExportDefaultDeclaration()) {
  ...
  const p = a ? n.node : fI("var", [hI(Hs(u), n.node)]), f = el(null, [tl(Hs(u), Gs("default"))]);
  return e.insertAfter(f), e.replaceWith(p), c && l.registerDeclaration(e), e;
...
fr.default = void 0;
fr.requeueComputedKeyAndDecorators = In;
fr.skipAllButComputedKey = function(t) {
...
const n = {
  ...
  ObjectProperty({
    ...
    if (o.shorthand && (c === u.oldName || c === u.newName) && l.getBindingIdentifier(c) === u.binding.identifier) {
      ...
      {
        var p;
        (p = o.extra) != null && p.shorthand && (o.extra.shorthand = !1);
      }
    }
  },
...
class a {
  ...
  rename() {
    const {
      ...
      scope: p,
      path: f
    } = l, h = f.find((b) => b.isDeclaration() || b.isFunctionExpression() || b.isClassExpression());
    h && h.getOuterBindingIdentifiers()[u] === l.identifier && this.maybeConvertFromExportDeclaration(h);
    const y = arguments[0] || p.block;
    (0, i.traverseNode)(y, (0, s.explode)(n), p, this, p.path, {
      discriminant: !0
    }), arguments[0] || (p.removeOwnBinding(u), p.bindings[c] = l, this.binding.identifier.name = c), h && (this.maybeConvertFromClassFunctionDeclaration(f), this.maybeConvertFromClassFunctionExpression(f));
  }
}
    ...
    exit(J) {
      ...
      if (_(O) || te(O)) {
        ...
        for (const M of O.declarations)
          for (const Z of Object.keys(p(M))) {
...
class He {
  ...
  generateUidIdentifierBasedOnNode(d, x) {
    return f(this.generateUidBasedOnNode(d, x));
  }
  isStatic(d) {
    if (V(d) || N(d) || _e(d))
      return !0;
  ...
  toArray(d, x, O) {
    ...
    if (ae(d, {
      ...
      return u(oe(oe(oe(f("Array"), f("prototype")), f("slice")), f("call")), [d]);
    let M;
    const Z = [d];
...
return sl || (sl = 1, function(e, t) {
  (function(r, i) {
    ...
    function a(u, c) {
      ...
      if (p !== void 0)
        return p;
      const { array: f, _indexes: h } = u, y = f.push(c);
      return h[c] = y - 1;
    }
    function o(u) {
      const { array: c, _indexes: p } = u;
      if (c.length === 0)
        return;
      const f = c.pop();
      p[f] = void 0;
    ...
    function l(u, c) {
      ...
      if (p === void 0)
        return;
      const { array: f, _indexes: h } = u;
      for (let y = p + 1; y < f.length; y++) {
        const b = f[y];
        f[y - 1] = b, h[b]--;
      }
      h[c] = void 0, f.pop();
...
return nl || (nl = 1, function(e, t) {
  (function(r, i) {
    ...
    const p = 1024 * 16, f = typeof TextDecoder < "u" ? /* @__PURE__ */ new TextDecoder() : typeof Buffer < "u" ? {
      decode(W) {
    ...
    class h {
      ...
      write(Q) {
        const { buffer: U } = this;
        U[this.pos++] = Q, this.pos === p && (this.out += f.decode(U), this.pos = 0);
      }
      flush() {
        const { buffer: Q, out: U, pos: L } = this;
        return L > 0 ? U + f.decode(Q.subarray(0, L)) : U;
      }
    }
    class y {
      constructor(Q) {
    ...
    function j(W) {
      ...
      do {
        ...
        for (; U.pos < se; U.pos++) {
          ...
          const Ue = l(U, 0), pe = Ue & 1, fe = Ue & 2, Se = Ue & 4;
          let Ce = null, Ee = b, Ne;
          if (pe) {
            const _e = l(U, B);
    ...
    function ce(W, Q, U, L) {
      ...
      if ($)
        for (const se of $) {
          ...
          u(U, oe, 0);
          let Ue = F, pe = B;
          for (let fe = 1; fe < se.length; fe++) {
            const Se = se[fe];
            Ue = u(U, Se[1], Ue), pe = u(U, Se[2], pe), u(U, Se[0], 0);
          }
        }
      for (Q++; Q < W.length; ) {
...
return al || (al = 1, function(e, t) {
  (function(r, i) {
    ...
    function c(_) {
      const j = i.exec(_);
      return f(j[1], j[2] || "", j[3], j[4] || "", j[5] || "/", j[6] || "", j[7] || "");
    }
    function p(_) {
      const j = s.exec(_), G = j[2];
      return f("file:", "", j[1] || "", "", o(G) ? G : "/" + G, j[3] || "", j[4] || "");
    }
    function f(_, j, G, ce, te, ae, q) {
      return {
        scheme: _,
        user: j,
        host: G,
...
(function(r, i) {
  ...
  const o = 0, l = 1, u = 2, c = 3, p = 4, f = 1, h = 2;
  function y(d, x) {
    const O = b(d, 0);
    if (O === d.length)
      return d;
  ...
  function k(d, x, O, M, Z, ee, ge, xe, ye, X, rt) {
    ...
    for (let mt = 0; mt < v.length; mt++) {
      ...
      for (let Ir = 0; Ir < gi.length; Ir++) {
        ...
        Ti.push(Ot.length === 4 ? [yr, bi, Si, Ei] : [yr, bi, Si, Ei, dt + Ot[p]]);
      }
    }
  }
  function F(d, x) {
  ...
  function pe(d, x) {
    ...
    return ve(rt[ye[l]], ye[u] + 1, ye[c], ye.length === 5 ? X[ye[p]] : null);
  }
  function fe(d, x) {
  ...
  function J(d, x, O, M, Z, ee) {
    ...
    if (it === -1)
      return Re(null, null);
    const dt = Ve[it];
    return Re(dt[f] + 1, dt[h]);
  }
  r.AnyMap = Q, r.GREATEST_LOWER_BOUND = V, r.LEAST_UPPER_BOUND = R, r.TraceMap = $, r.allGeneratedPositionsFor = Se, r.decodedMap = tt, r.decodedMappings = oe, r.eachMapping = Ce, r.encodedMap = Pe, r.encodedMappings = se, r.generatedPositionFor = fe, r.isIgnored = _e, r.originalPositionFor = pe, r.presortedDecodedMap = qe, r.sourceContentFor = Ne, r.traceSegment = Ue;
});
})(On, On.exports);
var sc = On.exports;
(function(e, t) {
(function(r, i) {
  ...
  function te(B) {
    const N = new n.TraceMap(B), D = new f({ file: N.file, sourceRoot: N.sourceRoot });
  ...
  function ae(B) {
    ...
    for (let $ = 0; $ < D.length; $++) {
      ...
      for (let se = 0; se < H.length; se++) {
        ...
        let pe, fe, Se;
        oe.length !== 1 && (pe = R.array[oe[1]], fe = { line: oe[2] + 1, column: oe[3] }, oe.length === 5 && (Se = V.array[oe[4]])), N.push({ generated: Ue, source: pe, original: fe, name: Se });
      }
    }
    return N;
  }
  function q(B, N, D, R, V, $, H, se, oe) {
    const { _mappings: Ue, _sources: pe, _sourcesContent: fe, _names: Se } = N, Ce = Y(Ue, D), Ee = re(Ce, R);
    if (!V)
      return B && L(Ce, Ee) ? void 0 : W(Ce, Ee, [R]);
    const Ne = i.put(pe, V), _e = se ? i.put(Se, se) : -1;
    if (Ne === fe.length && (fe[Ne] = oe ?? null), !(B && k(Ce, Ee, Ne, $, H, _e)))
  ...
  r.GenMapping = f, r.addMapping = b, r.addSegment = y, r.allMappings = ae, r.fromMap = te, r.maybeAddMapping = I, r.maybeAddSegment = A, r.setIgnore = j, r.setSourceContent = _, r.toDecodedMap = G, r.toEncodedMap = ce, Object.defineProperty(r, "__esModule", { value: !0 });
});
})(wn, wn.exports);
var tw = wn.exports;
Object.defineProperty(As, "__esModule", {
...
`), f = 0;
  for (p !== 0 && this._mark(c, a, o, l, u); p !== -1; )
    n.line++, n.column = 0, f = p + 1, f < s && c !== void 0 && this._mark(++c, 0, null, null, u), p = t.indexOf(`
`, f);
  n.column += s - f;
}
_mark(t, r, i, s, n) {
...
isOptionalMemberExpression: pw,
isStringLiteral: fw
} = sw;
function gr(e, t) {
return e && (Ta(e) || pw(e) ? (gr(e.object, t), e.computed && gr(e.property, t)) : ac(e) || nc(e) ? (gr(e.left, t), gr(e.right, t)) : oc(e) || cw(e) ? (t.hasCall = !0, gr(e.callee, t)) : qr(e) ? t.hasFunction = !0 : es(e) && (t.hasHelper = t.hasHelper || e.callee && jt(e.callee))), t;
}
function ol(e) {
return gr(e, {
  hasCall: !1,
...
for (; l >= 0; ) {
  const p = c.type;
  if (r && p === "ExpressionStatement" && c.expression === u || s && p === "ExportDefaultDeclaration" && u === c.declaration || i && p === "ArrowFunctionExpression" && c.body === u || n && p === "ForStatement" && c.init === u || a && p === "ForInStatement" && c.left === u || o && p === "ForOfStatement" && c.left === u)
    return !0;
  if (l > 0 && (li(u, c) && p !== "NewExpression" || p === "SequenceExpression" && c.expressions[0] === u || p === "UpdateExpression" && !c.prefix || p === "ConditionalExpression" && c.test === u || (p === "BinaryExpression" || p === "LogicalExpression") && c.left === u || p === "AssignmentExpression" && c.left === u))
    u = c, l--, c = e[l];
  else
    return !1;
}
...
const rO = pc(Yw), iO = pc(Xw.nodes);
function fc(e) {
return cc(e) ? !0 : Zw(e) && fc(e.object);
}
function Sa(e, t, r) {
var i;
if (!e) return !1;
...
function aO(e, t, r, i) {
var s;
return t ? eO(t) && t.callee === e && fc(e) ? !0 : zw(t) ? !Nn(e) && !(cc(e) && Nn(e.callee)) && !tO(e) : (s = rO.get(e.type)) == null ? void 0 : s(e, t, r, i) : !1;
}
function Nn(e) {
switch (e.type) {
  case "Identifier":
...
function gO(e, t) {
if (this.word("new"), this.space(), this.print(e.callee, e), this.format.minified && e.arguments.length === 0 && !e.optional && !pO(t, {
  callee: e
}) && !Ea(t) && !fO(t))
  return;
...
for (; ++i < r; )
  t(e[i]);
}, pi = bc.toString, ZN = Array.isArray, e2 = Buffer.isBuffer, t2 = (e) => pi.call(e) == "[object Object]", r2 = (e) => typeof e == "string" || pi.call(e) == "[object String]", i2 = (e) => typeof e == "number" || pi.call(e) == "[object Number]", s2 = (e) => typeof e == "function", n2 = (e) => pi.call(e) == "[object Map]", a2 = (e) => pi.call(e) == "[object Set]", o2 = {
'"': '\\"',
"'": "\\'",
"\\": "\\\\",
"\b": "\\b",
...
const c = t.__inline1__, p = t.__inline2__, f = a ? "" : `
`;
let h, y = !0;
...
if (s && e && s2(e.toJSON) && (e = e.toJSON()), !r2(e)) {
  ...
  if (ZN(e))
    return h = [], t.wrap = !0, c && (t.__inline1__ = !1, t.__inline2__ = !0), p || r(), QN(e, (te) => {
      y = !1, p && (t.__inline2__ = !1), h.push(
        (a || p ? "" : l) + Ht(te, t)
      );
    }), y ? "[]" : p ? "[" + h.join(", ") + "]" : "[" + f + h.join("," + f) + f + (a ? "" : u) + "]";
  if (i2(e)) {
    if (s)
  ...
  }), y ? "{}" : "{" + f + h.join("," + f) + f + (a ? "" : u) + "}") : s ? JSON.stringify(e) || "null" : String(e);
}
const j = e;
let G = -1;
const ce = j.length;
...
if (pl.has(e))
  ...
  const t = JSON.stringify(e), r = Array.from(pl, (i) => JSON.stringify(i));
...
ne.TSCallSignatureDeclaration = f_;
...
ne.TSImportEqualsDeclaration = fk;
ne.TSImportType = pk;
...
this.tokenChar(123), this.space(), i && (fl(this, i), this.word("readonly"), this.space()), this.tokenChar(91), this.word(s.name), this.space(), this.word("in"), this.space(), this.print(s.constraint, s), t && (this.space(), this.word("as"), this.space(), this.print(t, e)), this.tokenChar(93), r && (fl(this, r), this.tokenChar(63)), n && (this.tokenChar(58), this.space(), this.print(n, e)), this.space(), this.tokenChar(125);
}
function fl(e, t) {
t !== !0 && e.token(t);
}
...
Object.keys(t).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === t[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return t[f];
    }
...
Object.keys(r).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === r[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return r[f];
    }
...
Object.keys(i).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === i[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return i[f];
    }
...
Object.keys(s).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === s[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return s[f];
    }
...
Object.keys(n).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === n[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return n[f];
    }
...
Object.keys(a).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === a[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return a[f];
    }
...
Object.keys(o).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === o[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return o[f];
    }
...
Object.keys(l).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === l[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return l[f];
    }
...
Object.keys(u).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === u[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return u[f];
    }
...
Object.keys(c).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === c[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return c[f];
    }
...
Object.keys(p).forEach(function(f) {
  f === "default" || f === "__esModule" || f in e && e[f] === p[f] || Object.defineProperty(e, f, {
    enumerable: !0,
    get: function() {
      return p[f];
    }
...
print(t, r, i, s, n) {
  ...
  this.exactSource(A, p.bind(this, t, r)), y ? (this._printTrailingComments(t, r), this.tokenChar(41), this._noLineTerminator = i, b()) : i && !this._noLineTerminator ? (this._noLineTerminator = !0, this._printTrailingComments(t, r)) : this._printTrailingComments(t, r, s), this._printStack.pop(), u.concise = c, this._insideAux = f, this._endsWithInnerRaw = !1;
}
...
printJoin(t, r, i = {}) {
  ...
  if (s == null && this.format.retainLines) {
    var n;
    const p = (n = t[0].loc) == null ? void 0 : n.start.line;
    p != null && p !== this._buf.getCurrentLine() && (s = !0);
  }
  s && this.indent();
  const a = {
  ...
  for (let p = 0; p < l; p++) {
    const f = t[p];
    if (f && (i.statement && this._printNewline(p === 0, a), this.print(f, r, void 0, i.trailingCommentsLineOffset || 0), i.iterator == null || i.iterator(f, p), p < l - 1 && (o == null || o()), i.statement)) {
      var u;
...
`);
        ...
        (this._shouldIndent(47) || this.format.retainLines) && (p += this._getIndent()), o = o.replace(/\n(?!$)/g, `
${" ".repeat(p)}`);
      }
    }
...
_printComments(t, r, i, s, n = 0) {
  ...
  for (let y = 0; y < o; y++) {
    ...
    if (l && b.loc && A === 1) {
      ...
      if (t === 0) {
        let j = 0;
        y === 0 ? this._buf.hasContent() && (b.type === "CommentLine" || I !== _) && (j = f = 1) : j = I - p, p = _, h(j), this._printComment(b, 1), y + 1 === o && (h(Math.max(u - p, f)), p = u);
      } else if (t === 1) {
        const j = I - (y === 0 ? u : p);
        p = _, h(j), this._printComment(b, 1), y + 1 === o && (h(Math.min(1, c - p)), p = c);
      } else {
        const j = I - (y === 0 ? c - n : p);
        p = _, h(j), this._printComment(b, 1);
      }
    } else {
      if (l = !1, A !== 1)
        continue;
...
Object.defineProperty(e, "__esModule", {
  value: !0
}), e.ArrayExpression = Ue, e.AssignmentExpression = N, e.BinaryExpression = U, e.BooleanLiteral = $, e.CallExpression = _e, e.ConditionalExpression = k, e.ClassDeclaration = e.ClassExpression = e.FunctionDeclaration = e.ArrowFunctionExpression = e.FunctionExpression = fe, Object.defineProperty(e, "Identifier", {
  enumerable: !0,
  get: function() {
    return r.default;
  }
}), e.LogicalExpression = L, e.NewExpression = re, e.NullLiteral = H, e.NumericLiteral = V, e.ObjectExpression = oe, e.ParenthesizedExpression = B, e.RegExpLiteral = se, e.RestElement = pe, e.SequenceExpression = F, e.StringLiteral = R, e.TSAsExpression = q, e.TSNonNullExpression = Y, e.TaggedTemplateExpression = qe, e.TemplateLiteral = W, e.TypeCastExpression = ae, e.UnaryExpression = Q, e.UpdateExpression = D, e.VariableDeclarator = te;
var t = Ae(), r = va, i = _s;
const {
...
const Se = f("Array.from"), Ce = f("Object.keys"), Ee = f("Object.values"), Ne = f("Object.entries");
function _e() {
  const {
    callee: Pe
  } = this.node;
...
isGenericTypeAnnotation: pD,
isIdentifier: gl,
isMixedTypeAnnotation: fD,
...
function wD(e) {
const t = this.getTypeAnnotation();
return e === "Array" && (mD(t) || oD(t) || gD(t)) ? !0 : pD(t) && gl(t.id, {
  name: e
}) || TD(t) && gl(t.typeName, {
  name: e
});
...
i.rgb.hsl = function(l) {
  var u = l[0] / 255, c = l[1] / 255, p = l[2] / 255, f = Math.min(u, c, p), h = Math.max(u, c, p), y = h - f, b, A, I;
  return h === f ? b = 0 : u === h ? b = (c - p) / y : c === h ? b = 2 + (p - u) / y : p === h && (b = 4 + (u - c) / y), b = Math.min(b * 60, 360), b < 0 && (b += 360), I = (f + h) / 2, h === f ? A = 0 : I <= 0.5 ? A = y / (h + f) : A = y / (2 - h - f), [b, A * 100, I * 100];
}, i.rgb.hsv = function(l) {
  var u, c, p, f, h, y = l[0] / 255, b = l[1] / 255, A = l[2] / 255, I = Math.max(y, b, A), _ = I - Math.min(y, b, A), j = function(G) {
    return (I - G) / 6 / _ + 1 / 2;
  };
  return _ === 0 ? f = h = 0 : (h = _ / I, u = j(y), c = j(b), p = j(A), y === I ? f = p - c : b === I ? f = 1 / 3 + u - p : A === I && (f = 2 / 3 + c - u), f < 0 ? f += 1 : f > 1 && (f -= 1)), [
    f * 360,
    h * 100,
    I * 100
  ];
}, i.rgb.hwb = function(l) {
  var u = l[0], c = l[1], p = l[2], f = i.rgb.hsl(l)[0], h = 1 / 255 * Math.min(u, Math.min(c, p));
  return p = 1 - 1 / 255 * Math.max(u, Math.max(c, p)), [f, h * 100, p * 100];
}, i.rgb.cmyk = function(l) {
  var u = l[0] / 255, c = l[1] / 255, p = l[2] / 255, f, h, y, b;
  return b = Math.min(1 - u, 1 - c, 1 - p), f = (1 - u - b) / (1 - b) || 0, h = (1 - c - b) / (1 - b) || 0, y = (1 - p - b) / (1 - b) || 0, [f * 100, h * 100, y * 100, b * 100];
};
function o(l, u) {
...
return i.rgb.keyword = function(l) {
  ...
  var u = l[0] / 255, c = l[1] / 255, p = l[2] / 255;
  u = u > 0.04045 ? Math.pow((u + 0.055) / 1.055, 2.4) : u / 12.92, c = c > 0.04045 ? Math.pow((c + 0.055) / 1.055, 2.4) : c / 12.92, p = p > 0.04045 ? Math.pow((p + 0.055) / 1.055, 2.4) : p / 12.92;
  var f = u * 0.4124 + c * 0.3576 + p * 0.1805, h = u * 0.2126 + c * 0.7152 + p * 0.0722, y = u * 0.0193 + c * 0.1192 + p * 0.9505;
  return [f * 100, h * 100, y * 100];
}, i.rgb.lab = function(l) {
  var u = i.rgb.xyz(l), c = u[0], p = u[1], f = u[2], h, y, b;
  return c /= 95.047, p /= 100, f /= 108.883, c = c > 8856e-6 ? Math.pow(c, 1 / 3) : 7.787 * c + 16 / 116, p = p > 8856e-6 ? Math.pow(p, 1 / 3) : 7.787 * p + 16 / 116, f = f > 8856e-6 ? Math.pow(f, 1 / 3) : 7.787 * f + 16 / 116, h = 116 * p - 16, y = 500 * (c - p), b = 200 * (p - f), [h, y, b];
}, i.hsl.rgb = function(l) {
  var u = l[0] / 360, c = l[1] / 100, p = l[2] / 100, f, h, y, b, A;
  if (c === 0)
    return A = p * 255, [A, A, A];
  p < 0.5 ? h = p * (1 + c) : h = p + c - p * c, f = 2 * p - h, b = [0, 0, 0];
  for (var I = 0; I < 3; I++)
    y = u + 1 / 3 * -(I - 1), y < 0 && y++, y > 1 && y--, 6 * y < 1 ? A = f + (h - f) * 6 * y : 2 * y < 1 ? A = h : 3 * y < 2 ? A = f + (h - f) * (2 / 3 - y) * 6 : A = f, b[I] = A * 255;
  return b;
}, i.hsl.hsv = function(l) {
  var u = l[0], c = l[1] / 100, p = l[2] / 100, f = c, h = Math.max(p, 0.01), y, b;
  return p *= 2, c *= p <= 1 ? p : 2 - p, f *= h <= 1 ? h : 2 - h, b = (p + c) / 2, y = p === 0 ? 2 * f / (h + f) : 2 * c / (p + c), [u, y * 100, b * 100];
}, i.hsv.rgb = function(l) {
  var u = l[0] / 60, c = l[1] / 100, p = l[2] / 100, f = Math.floor(u) % 6, h = u - Math.floor(u), y = 255 * p * (1 - c), b = 255 * p * (1 - c * h), A = 255 * p * (1 - c * (1 - h));
  switch (p *= 255, f) {
    case 0:
      return [p, A, y];
    case 1:
  ...
  var u = l[0], c = l[1] / 100, p = l[2] / 100, f = Math.max(p, 0.01), h, y, b;
  return b = (2 - c) * p, h = (2 - c) * f, y = c * f, y /= h <= 1 ? h : 2 - h, y = y || 0, b /= 2, [u, y * 100, b * 100];
}, i.hwb.rgb = function(l) {
  var u = l[0] / 360, c = l[1] / 100, p = l[2] / 100, f = c + p, h, y, b, A;
  f > 1 && (c /= f, p /= f), h = Math.floor(6 * u), y = 1 - p, b = 6 * u - h, h & 1 && (b = 1 - b), A = c + b * (y - c);
  var I, _, j;
  switch (h) {
    default:
    case 6:
  ...
  var u = l[0] / 100, c = l[1] / 100, p = l[2] / 100, f = l[3] / 100, h, y, b;
  return h = 1 - Math.min(1, u * (1 - f) + f), y = 1 - Math.min(1, c * (1 - f) + f), b = 1 - Math.min(1, p * (1 - f) + f), [h * 255, y * 255, b * 255];
}, i.xyz.rgb = function(l) {
  var u = l[0] / 100, c = l[1] / 100, p = l[2] / 100, f, h, y;
  return f = u * 3.2406 + c * -1.5372 + p * -0.4986, h = u * -0.9689 + c * 1.8758 + p * 0.0415, y = u * 0.0557 + c * -0.204 + p * 1.057, f = f > 31308e-7 ? 1.055 * Math.pow(f, 1 / 2.4) - 0.055 : f * 12.92, h = h > 31308e-7 ? 1.055 * Math.pow(h, 1 / 2.4) - 0.055 : h * 12.92, y = y > 31308e-7 ? 1.055 * Math.pow(y, 1 / 2.4) - 0.055 : y * 12.92, f = Math.min(Math.max(0, f), 1), h = Math.min(Math.max(0, h), 1), y = Math.min(Math.max(0, y), 1), [f * 255, h * 255, y * 255];
}, i.xyz.lab = function(l) {
  var u = l[0], c = l[1], p = l[2], f, h, y;
  return u /= 95.047, c /= 100, p /= 108.883, u = u > 8856e-6 ? Math.pow(u, 1 / 3) : 7.787 * u + 16 / 116, c = c > 8856e-6 ? Math.pow(c, 1 / 3) : 7.787 * c + 16 / 116, p = p > 8856e-6 ? Math.pow(p, 1 / 3) : 7.787 * p + 16 / 116, f = 116 * c - 16, h = 500 * (u - c), y = 200 * (c - p), [f, h, y];
}, i.lab.xyz = function(l) {
  var u = l[0], c = l[1], p = l[2], f, h, y;
  h = (u + 16) / 116, f = c / 500 + h, y = h - p / 200;
  var b = Math.pow(h, 3), A = Math.pow(f, 3), I = Math.pow(y, 3);
  return h = b > 8856e-6 ? b : (h - 16 / 116) / 7.787, f = A > 8856e-6 ? A : (f - 16 / 116) / 7.787, y = I > 8856e-6 ? I : (y - 16 / 116) / 7.787, f *= 95.047, h *= 100, y *= 108.883, [f, h, y];
}, i.lab.lch = function(l) {
  var u = l[0], c = l[1], p = l[2], f, h, y;
  return f = Math.atan2(p, c), h = f * 360 / 2 / Math.PI, h < 0 && (h += 360), y = Math.sqrt(c * c + p * p), [u, y, h];
}, i.lch.lab = function(l) {
  var u = l[0], c = l[1], p = l[2], f, h, y;
  return y = p / 360 * 2 * Math.PI, f = c * Math.cos(y), h = c * Math.sin(y), [u, f, h];
}, i.rgb.ansi16 = function(l) {
  var u = l[0], c = l[1], p = l[2], f = 1 in arguments ? arguments[1] : i.rgb.hsv(l)[2];
  if (f = Math.round(f / 50), f === 0)
    return 30;
  var h = 30 + (Math.round(p / 255) << 2 | Math.round(c / 255) << 1 | Math.round(u / 255));
  return f === 2 && (h += 60), h;
}, i.hsv.ansi16 = function(l) {
  return i.rgb.ansi16(i.hsv.rgb(l), l[2]);
}, i.rgb.ansi256 = function(l) {
  var u = l[0], c = l[1], p = l[2];
  if (u === c && c === p)
    return u < 8 ? 16 : u > 248 ? 231 : Math.round((u - 8) / 247 * 24) + 232;
  var f = 16 + 36 * Math.round(u / 255 * 5) + 6 * Math.round(c / 255 * 5) + Math.round(p / 255 * 5);
  return f;
}, i.ansi16.rgb = function(l) {
  var u = l % 10;
  if (u === 0 || u === 7)
    return l > 50 && (u += 3.5), u = u / 10.5 * 255, [u, u, u];
  var c = (~~(l > 50) + 1) * 0.5, p = (u & 1) * c * 255, f = (u >> 1 & 1) * c * 255, h = (u >> 2 & 1) * c * 255;
  return [p, f, h];
  ...
  l -= 16;
  var c, p = Math.floor(l / 36) / 5 * 255, f = Math.floor((c = l % 36) / 6) / 5 * 255, h = c % 6 / 5 * 255;
  return [p, f, h];
  ...
  var p = parseInt(c, 16), f = p >> 16 & 255, h = p >> 8 & 255, y = p & 255;
  return [f, h, y];
}, i.rgb.hcg = function(l) {
  var u = l[0] / 255, c = l[1] / 255, p = l[2] / 255, f = Math.max(Math.max(u, c), p), h = Math.min(Math.min(u, c), p), y = f - h, b, A;
  return y < 1 ? b = h / (1 - y) : b = 0, y <= 0 ? A = 0 : f === u ? A = (c - p) / y % 6 : f === c ? A = 2 + (p - u) / y : A = 4 + (u - c) / y + 4, A /= 6, A %= 1, [A * 360, y * 100, b * 100];
}, i.hsl.hcg = function(l) {
  var u = l[1] / 100, c = l[2] / 100, p = 1, f = 0;
  return c < 0.5 ? p = 2 * u * c : p = 2 * u * (1 - c), p < 1 && (f = (c - 0.5 * p) / (1 - p)), [l[0], p * 100, f * 100];
}, i.hsv.hcg = function(l) {
  var u = l[1] / 100, c = l[2] / 100, p = u * c, f = 0;
  return p < 1 && (f = (c - p) / (1 - p)), [l[0], p * 100, f * 100];
}, i.hcg.rgb = function(l) {
  var u = l[0] / 360, c = l[1] / 100, p = l[2] / 100;
  if (c === 0)
    return [p * 255, p * 255, p * 255];
  var f = [0, 0, 0], h = u % 1 * 6, y = h % 1, b = 1 - y, A = 0;
  switch (Math.floor(h)) {
    case 0:
      f[0] = 1, f[1] = y, f[2] = 0;
      break;
  ...
  var u = l[1] / 100, c = l[2] / 100, p = u + c * (1 - u), f = 0;
  return p > 0 && (f = u / p), [l[0], f * 100, p * 100];
}, i.hcg.hsl = function(l) {
  var u = l[1] / 100, c = l[2] / 100, p = c * (1 - u) + 0.5 * u, f = 0;
  return p > 0 && p < 0.5 ? f = u / (2 * p) : p >= 0.5 && p < 1 && (f = u / (2 * (1 - p))), [l[0], f * 100, p * 100];
}, i.hcg.hwb = function(l) {
  var u = l[1] / 100, c = l[2] / 100, p = u + c * (1 - u);
  return [l[0], (p - u) * 100, (1 - p) * 100];
}, i.hwb.hcg = function(l) {
  var u = l[1] / 100, c = l[2] / 100, p = 1 - c, f = p - u, h = 0;
  return f < 1 && (h = (p - f) / (1 - f)), [l[0], f * 100, h * 100];
  ...
  var u = Math.round(l[0] / 100 * 255) & 255, c = (u << 16) + (u << 8) + u, p = c.toString(16).toUpperCase();
...
function r(n) {
  ...
  for (a[n].distance = 0; o.length; )
    for (var l = o.pop(), u = Object.keys(e[l]), c = u.length, p = 0; p < c; p++) {
      var f = u[p], h = a[f];
      h.distance === -1 && (h.distance = a[l].distance + 1, h.parent = l, o.unshift(f));
    }
  return a;
}
function i(n, a) {
...
function a(u, c) {
  const p = [], f = c.trim().split(/\s*,\s*/g);
  let h;
  for (const y of f)
    if (!isNaN(y))
      p.push(Number(y));
    else if (h = y.match(r))
      p.push(h[2].replace(i, (b, A, I) => A ? n(A) : I));
    else
...
return un = (u, c) => {
  ...
  if (c.replace(e, (y, b, A, I, _, j) => {
    if (b)
      ...
      const G = h.join("");
      h = [], f.push(p.length === 0 ? G : l(u, p)(G)), p.push({ inverse: A, styles: o(I) });
    } else if (_) {
      if (p.length === 0)
        throw new Error("Found extraneous } in Chalk template literal");
      f.push(l(u, p)(h.join(""))), h = [], p.pop();
    } else
      h.push(j);
...
return Il || (Il = 1, function(e) {
  ...
  for (const b of Object.keys(r))
    r[b].closeRe = new RegExp(t(r[b].close), "g"), l[b] = {
      get() {
        const A = r[b];
        return f.call(this, this._styles ? this._styles.concat(A) : [A], this._empty, b);
      }
    };
  l.visible = {
    get() {
    ...
    o.has(b) || (l[b] = {
      get() {
        ...
        return function() {
          ...
          return f.call(this, this._styles ? this._styles.concat(_) : [_], this._empty, b);
        };
      }
    });
    ...
    l[A] = {
      get() {
        ...
        return function() {
          ...
          return f.call(this, this._styles ? this._styles.concat(j) : [j], this._empty, b);
        };
      }
    };
  }
  ...
  function f(b, A, I) {
    ...
    }), _.hasGrey = this.hasGrey || I === "gray" || I === "grey", _.__proto__ = p, _;
  }
  function h() {
...
if (e) {
  var t;
  return (t = pn) != null || (pn = (0, Dn.createColors)(!0)), pn;
}
return JD;
}
let Dl = !1;
...
let p = Math.max(o - (n + 1), 0), f = Math.min(t.length, u + a);
...
const i = (r.highlightCode || r.forceColor) && (0, _l.shouldHighlight)(r), s = XD(r.forceColor), n = YD(s), a = (b, A) => i ? b(A) : A, o = e.split(Ll), {
  ...
  markerLines: c
} = HD(t, o, r), p = t.start && typeof t.start.column == "number", f = String(u).length;
let y = (i ? (0, _l.default)(e, r) : e).split(Ll, u).slice(l, u).map((b, A) => {
  const I = l + 1 + A, j = ` ${` ${I}`.slice(-f)} |`, G = c[I], ce = !c[I + 1];
  if (G) {
    let te = "";
    if (Array.isArray(G)) {
...
`);
return r.message && !p && (y = `${" ".repeat(f + 1)}${r.message}
${y}`), i ? s.reset(y) : y;
}
function GD(e, t, r, i = {}) {
if (!Dl) {
...
Ml = 1, Object.defineProperty(Lt, "__esModule", {
  value: !0
}), Lt._assertUnremoved = p, Lt._callRemovalHooks = l, Lt._markRemoved = c, Lt._remove = u, Lt._removeFromScope = o, Lt.remove = a;
var e = Ls, t = nt, r = pp(), i = mr(), s = Ae();
const {
  getBindingIdentifiers: n
} = s;
function a() {
  var f;
  if (p.call(this), this.resync(), (f = this.opts) != null && f.noScope || o.call(this), l.call(this)) {
    c.call(this);
    return;
  }
...
function o() {
  const f = n(this.node, !1, !1, !0);
  Object.keys(f).forEach((h) => this.scope.removeBinding(h));
}
function l() {
  if (this.parentPath) {
    for (const f of e.hooks)
      if (f(this, this.parentPath)) return !0;
  }
}
function u() {
...
Bl = 1, Object.defineProperty(Ge, "__esModule", {
  value: !0
}), Ge._call = s, Ge._getQueueContexts = ae, Ge._resyncKey = b, Ge._resyncList = A, Ge._resyncParent = y, Ge._resyncRemoved = I, Ge.call = i, Ge.isBlacklisted = Ge.isDenylisted = n, Ge.popContext = _, Ge.pushContext = j, Ge.requeue = te, Ge.resync = h, Ge.setContext = f, Ge.setKey = ce, Ge.setScope = p, Ge.setup = G, Ge.skip = l, Ge.skipKey = u, Ge.stop = c, Ge.visit = o;
var e = Ha(), t = mr(), r = Ca();
function i(q) {
  const Y = this.opts;
...
function Q(N) {
  ...
  if (R.isExpressionStatement() || R.isLabeledStatement() || b(V) || R.isExportDefaultDeclaration() && this.isDeclaration())
    return R.insertAfter(D.map(($) => A($) ? f($) : $));
  if (this.isNodeType("Expression") && !this.isJSXElement() && !R.isJSXElement() || R.isForStatement() && this.key === "init") {
    ...
    if ($.node) {
      ...
      if (re($))
        ...
        D.unshift(f(l("=", p(oe), H))), D.push(f(p(oe)));
      }
    }
...
return function i(s, n) {
  ...
  return Object.assign(a, r, {
    ...
    return i(new Gt(c, p, f), Object.assign({}, n, l.details));
...
for (const i of Object.keys(e)) {
  const s = e[i], n = typeof s == "string" ? {
    ...
    message: a
  } = n, o = Wc(n, pL), l = typeof a == "string" ? () => a : a;
  r[i] = fL(Object.assign({
...
$e.template = new Wr("`", !0);
const we = !0, ie = !0, fn = !0, jr = !0, Jt = !0, mL = !0;
class Jc {
constructor(t, r = {}) {
...
for (; i === null && s > 0; )
  i = t[--s];
i === null || i.start > r.start ? zr(e, r.comments) : ep(i, r.comments);
}
class $L extends RL {
addComment(t) {
...
finalizeComment(t) {
  ...
  if (t.leadingNode !== null || t.trailingNode !== null)
    t.leadingNode !== null && ep(t.leadingNode, r), t.trailingNode !== null && UL(t.trailingNode, r);
  else {
    const {
      containingNode: i,
      start: s
...
`);
  ...
  case 117: {
    ...
    return {
      code: u,
      pos: t
    } = ip(e, t, r, i, a, n), o(u === null ? null : String.fromCodePoint(u));
  }
  case 116:
    return o("	");
  case 98:
...
return {
  n: u,
  pos: t
} = rp(e, t, r, i, 16, s, n, !1, o, !a), u === null && (a ? o.invalidEscapeSequence(l, r, i) : t = l - 1), {
  code: u,
  pos: t
};
}
function rp(e, t, r, i, s, n, a, o, l, u) {
const c = t, p = s === 16 ? ql.hex : ql.decBinOct, f = s === 16 ? qi.hex : s === 10 ? qi.dec : s === 8 ? qi.oct : qi.bin;
let h = !1, y = 0;
for (let b = 0, A = n ?? 1 / 0; b < A; ++b) {
  const I = e.charCodeAt(t);
  let _;
...
readInt(t, r, i = !1, s = !0) {
  const {
    n,
    pos: a
  } = rp(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, r, i, s, this.errorHandlers_readInt, !1);
...
readNumber(t) {
  ...
  const f = l ? parseInt(p, 8) : parseFloat(p);
...
readCodePoint(t) {
  const {
    code: r,
    pos: i
  } = ip(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
...
declarePrivateName(t, r, i) {
  ...
  if (r & 3) {
    const l = o && n.get(t);
    if (l) {
      const u = l & 4, c = r & 4, p = l & 3, f = r & 3;
      o = p === f || u !== c, o || n.delete(t);
    } else o || n.set(t, r);
  }
...
hasPrecedingLineBreak() {
  return tp.test(this.input.slice(this.state.lastTokEndLoc.index, this.state.start));
}
...
flowParseObjectType({
  ...
  for (i && this.match(6) ? (this.expect(6), u = 9, c = !0) : (this.expect(5), u = 8, c = !1), l.exact = c; !this.match(u); ) {
    ...
    if (this.eat(0))
      ...
      j === null ? (p = !0, b = this.state.lastTokStartLoc) : l.properties.push(j);
    }
  ...
  const f = this.finishNode(l, "ObjectTypeAnnotation");
...
parseConditional(r, i, s) {
  ...
  if (u || p.length > 0) {
    ...
    u && c.length > 1 && this.raise(me.AmbiguousConditionalArrow, n.startLoc), u && c.length === 1 && (this.state = n, f.push(c[0].start), this.state.noArrowAt = f, {
      consequent: l,
      failed: u
...
parseImportSpecifier(r, i, s, n, a) {
  ...
  if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
    ...
    l !== null && !At(this.state.type) ? (r.imported = p, r.importKind = l, r.local = $t(p)) : (r.imported = o, r.importKind = null, r.local = this.parseIdentifier());
  } else {
...
parseMaybeAssign(r, i) {
  ...
  if ((s = a) != null && s.error || this.match(47)) {
    ...
    const c = this.tryParse((f) => {
      ...
      (h = y.extra) != null && h.parenthesized && f();
      const b = this.maybeUnwrapTypeCastExpression(y);
      return b.type !== "ArrowFunctionExpression" && f(), b.typeParameters = u, this.resetStartLocationFromNode(b, u), y;
    }, n);
    let p = null;
...
flowEnumBody(r, i) {
  ...
  switch (r.hasUnknownMembers = l, a) {
    ...
    default: {
      ...
      r.explicitType = !1;
      const c = o.booleanMembers.length, p = o.numberMembers.length, f = o.stringMembers.length, h = o.defaultedMembers.length;
      if (!c && !p && !f && !h)
        return u();
      if (!c && !p)
...
jsxReadEntity() {
  ...
  if (this.codePointAtPos(this.state.pos) === 35) {
    ...
    for (; i++ < 10 && this.state.pos < this.length && !(s = this.codePointAtPos(this.state.pos) === 59); )
      ++this.state.pos;
    if (s) {
      const n = this.input.slice(r, this.state.pos), a = pM[n];
      if (++this.state.pos, a)
        return a;
    }
  }
...
const mM = (e, t) => hasOwnProperty.call(e, t) && e[t], ap = (e) => e.type === "ParenthesizedExpression" ? ap(e.expression) : e;
class yM extends sM {
toAssignable(t, r = !1) {
  var i, s;
  let n;
  switch ((t.type === "ParenthesizedExpression" || (i = t.extra) != null && i.parenthesized) && (n = ap(t), r ? n.type === "Identifier" ? this.expressionScope.recordArrowParameterBindingError(w.InvalidParenthesizedAssignment, t) : n.type !== "MemberExpression" && !this.isOptionalMemberExpression(n) && this.raise(w.InvalidParenthesizedAssignment, t) : this.raise(w.InvalidParenthesizedAssignment, t)), t.type) {
    case "Identifier":
    case "ObjectPattern":
    case "ArrayPattern":
    case "AssignmentPattern":
    ...
    case "ObjectExpression":
      ...
      for (let o = 0, l = t.properties.length, u = l - 1; o < l; o++) {
        ...
        this.toAssignableObjectExpressionProp(c, p, r), p && c.type === "RestElement" && (a = t.extra) != null && a.trailingCommaLoc && this.raise(w.RestTrailingComma, t.extra.trailingCommaLoc);
      }
      break;
    case "ObjectProperty": {
      const {
...
checkLVal(t, {
  ...
  const [p, f] = Array.isArray(c) ? c : [c, l === "ParenthesizedExpression"], h = l === "ArrayPattern" || l === "ObjectPattern" ? {
    type: l
  } : r;
  for (const y of [].concat(t[p]))
    y && this.checkLVal(y, {
      in: h,
      binding: i,
      checkClashes: s,
...
tsParseModifiers({
  ...
  const o = (u, c, p, f) => {
    c === p && a[f] && this.raise(le.InvalidModifiersOrder, u, {
      orderedModifiers: [p, f]
    });
  }, l = (u, c, p, f) => {
    (a[p] && c === f || a[f] && c === p) && this.raise(le.IncompatibleModifiers, u, {
      modifiers: [p, f]
    });
  };
  for (; ; ) {
...
tsParseTupleElementType() {
  ...
  if (u === 58)
    ...
    a = !0;
    const c = this.state.startLoc, p = this.state.value, f = this.tsParseNonArrayType();
    this.lookaheadCharCode() === 58 ? (s = !0, n = this.createIdentifier(this.startNodeAt(c), p), this.expect(17), this.expect(14), o = this.tsParseType()) : (s = !1, o = f, this.expect(17));
  } else
...
parseAssignableListItem(r, i) {
  ...
  if (a || l || o) {
    ...
    return i.length && (p.decorators = i), a && (p.accessibility = a), l && (p.readonly = l), o && (p.override = o), c.type !== "Identifier" && c.type !== "AssignmentPattern" && this.raise(le.UnsupportedParameterPropertyKind, p), p.parameter = c, this.finishNode(p, "TSParameterProperty");
  }
  ...
  if (this.match(47) || this.match(51)) {
    ...
    const l = this.tsTryParseAndCatch(() => {
      if (!s && this.atPossibleAsyncArrow(r)) {
        const f = this.tsTryParseGenericAsyncArrowFunction(i);
        if (f)
          return f;
      }
      ...
      if (is(this.state.type)) {
        const f = super.parseTaggedTemplateExpression(r, i, n);
        return f.typeParameters = u, f;
      }
      if (!s && this.eat(10)) {
        const f = this.startNodeAt(i);
        return f.callee = r, f.arguments = this.parseCallExpressionArguments(11, !1), this.tsCheckForInvalidTypeCasts(f.arguments), f.typeParameters = u, n.optionalChainMember && (f.optional = a), this.finishCallExpression(f, n.optionalChainMember);
      }
...
parseMaybeAssign(r, i) {
  ...
  const h = this.tryParse((y) => {
    ...
    return (I.type !== "ArrowFunctionExpression" || (b = I.extra) != null && b.parenthesized) && y(), ((A = f) == null ? void 0 : A.params.length) !== 0 && this.resetStartLocationFromNode(I, f), I.typeParameters = f, I;
  }, u);
  if (!h.error && !h.aborted)
    return f && this.reportReservedArrowTypeParam(f), h.node;
  if (!c && (Xl(!this.hasPlugin("jsx")), p = this.tryParse(() => super.parseMaybeAssign(r, i), u), !p.error))
    return p.node;
  if ((n = c) != null && n.node)
    return this.state = c.failState, c.node;
  if (h.node)
    return this.state = h.failState, f && this.reportReservedArrowTypeParam(f), h.node;
  if ((a = p) != null && a.node)
    return this.state = p.failState, p.node;
  throw ((o = c) == null ? void 0 : o.error) || h.error || ((l = p) == null ? void 0 : l.error);
}
...
parseTypeOnlyImportExportSpecifier(r, i, s) {
  ...
  u && s && this.raise(i ? le.TypeModifierIsUsedInTypeImports : le.TypeModifierIsUsedInTypeExports, p), r[n] = o, r[a] = l;
  const f = i ? "importKind" : "exportKind";
  r[f] = u ? "type" : "value", c && this.eatContextual(93) && (r[a] = i ? this.parseIdentifier() : this.parseModuleExportName()), r[a] || (r[a] = $t(r[n])), i && this.checkIdentifier(r[a], u ? 4098 : 4096);
}
};
function PM(e) {
...
return t && r.type !== "StringLiteral" && (r.type !== "TemplateLiteral" || r.expressions.length > 0) ? !1 : lp(e.object);
}
function xM(e, t) {
var r;
const {
...
if (t) {
  ...
  return !0;
return !!(op(e, t) || vM(e, t) || i === "TemplateLiteral" && e.expressions.length === 0 || PM(e));
}
function op(e, t) {
...
function lp(e) {
return e.type === "Identifier" ? !0 : e.type !== "MemberExpression" || e.computed ? !1 : lp(e.object);
}
...
`),
  ...
  return this.resetEndLocation(p, ht(this.state.lastTokEndLoc, u)), p;
}
parseTemplate(t) {
  const r = this.startNode();
...
parseFunctionBody(t, r, i = !1) {
  ...
  if (this.expressionScope.enter(np()), s)
  ...
  if (typeof s == "number") {
    {
      ...
      if (is(s)) {
        ...
        let f, h, y, b;
        s === 24 ? (h = l - 1, y = ht(n.end, -1), f = o === null ? null : o.slice(1, -1), b = new Yt({
          type: Mt(22),
          value: "`",
          start: h,
          end: l,
          startLoc: y,
          endLoc: n.end
        })) : (h = l - 2, y = ht(n.end, -2), f = o === null ? null : o.slice(1, -2), b = new Yt({
          type: Mt(23),
          value: "${",
          start: h,
          end: l,
...
parseForStatement(t) {
  ...
  const i = this.isContextual(100);
  {
    ...
    if (this.match(74) || this.match(75) || c) {
      ...
      let f;
      l ? (f = "await using", this.isAwaitAllowed() || this.raise(w.AwaitUsingNotInAsyncContext, this.state.startLoc), this.next()) : f = this.state.value, this.next(), this.parseVar(p, !0, f);
      const h = this.finishNode(p, "VariableDeclaration"), y = this.match(58);
...
parseClassMemberWithIsStatic(t, r, i, s) {
  ...
  const f = !this.state.containsEsc && Le(this.state.type), h = this.parseClassElementName(r), y = f ? h.name : null, b = this.isPrivateName(h), A = this.state.startLoc;
  if (this.parsePostMemberNameModifiers(p), this.isClassMethod()) {
    ...
    const I = this.eat(55);
    p.optional && this.unexpected(A), c.kind = "method";
    const _ = this.match(138);
    this.parseClassElementName(c), this.parsePostMemberNameModifiers(p), _ ? this.pushClassPrivateMethod(t, a, I, !0) : (this.isNonstaticConstructor(n) && this.raise(w.ConstructorIsAsync, n.key), this.pushClassMethod(t, n, I, !0, !1, !1));
...
parseInitializer(t) {
  this.scope.enter(80), this.expressionScope.enter(np()), this.prodParam.enter(0), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
}
...
parseExport(t, r) {
  ...
  if (u || c || p) {
    var f;
    const h = t;
    if (this.checkExport(h, !0, !1, !!h.source), ((f = h.declaration) == null ? void 0 : f.type) === "ClassDeclaration")
...
var e = fi, t = Us(), r = mr(), i = nt, s = qc(), n = Ar, a = Ae(), o = Ua;
const {
  FUNCTION_TYPES: l,
...
function R(pe) {
  var fe;
  this.resync(), pe = s._verifyNodeList.call(this, pe), G(pe[0], this.node), ce(pe[pe.length - 1], this.node), (fe = (0, i.getCachedPaths)(this.hub, this.parent)) == null || fe.delete(this.node), this.node = this.container[this.key] = null;
  const Se = this.insertAfter(pe);
...
function $(pe) {
  ...
  let Se = "";
  if (this.isNodeType("Statement") && Y(fe) && !this.canHaveVariableDeclarationOrExpression() && !this.canSwapBetweenExpressionAndStatement(fe) && !this.parentPath.isExportDefaultDeclaration() && (fe = I(fe), Se = "expression"), this.isNodeType("Expression") && U(fe) && !this.canHaveVariableDeclarationOrExpression() && !this.canSwapBetweenExpressionAndStatement(fe))
    return this.replaceExpressionWithStatements([fe]);
  const Ce = this.node;
  return Ce && (te(fe, Ce), k(Ce)), H.call(this, fe), this.type = fe.type, this.setScope(), this.requeue(), [Se ? this.get(Se) : this];
}
function H(pe) {
  var fe;
  if (!this.container)
    throw new ReferenceError("Container is falsy");
  this.inList ? N(this.parent, this.key, [pe]) : N(this.parent, this.key, pe), this.debug(`Replace with ${pe == null ? void 0 : pe.type}`), (fe = (0, i.getCachedPaths)(this.hub, this.parent)) == null || fe.set(pe, this).delete(this.node), this.node = this.container[this.key] = pe;
}
function se(pe) {
  this.resync();
  const fe = [], Se = oe(pe, fe);
  if (Se) {
    for (const Re of fe) this.scope.push({
      id: Re
    });
    return this.replaceWith(Se)[0].get("expressions");
  }
  const Ce = this.getFunctionParent(), Ee = Ce == null ? void 0 : Ce.is("async"), Ne = Ce == null ? void 0 : Ce.is("generator"), _e = u([], f(pe));
  ...
  return Be && (Pe.set("async", !0), ve || this.replaceWith(p(this.node))), ve && (Pe.set("generator", !0), this.replaceWith(D(this.node, !0))), Pe.get("body.body");
}
function oe(pe, fe) {
  const Se = [];
  let Ce = !0;
  for (const Ee of pe)
    if (q(Ee) || (Ce = !1), Y(Ee))
      ...
      const Ne = Ee.consequent ? oe([Ee.consequent], fe) : h(), _e = Ee.alternate ? oe([Ee.alternate], fe) : h();
      if (!Ne || !_e) return;
      Se.push(A(Ee.test, Ne, _e));
    } else if (ae(Ee)) {
      const Ne = oe(Ee.body, fe);
      if (!Ne) return;
      Se.push(Ne);
    } else if (q(Ee))
      pe.indexOf(Ee) === 0 && (Ce = !0);
    else
      return;
...
function Ue(pe) {
  if (this.resync(), Array.isArray(pe))
    if (Array.isArray(this.container)) {
      ...
      const fe = s._containerInsertAfter.call(this, pe);
...
if (t.confident) {
  ...
  if (e.isConditionalExpression()) {
    const r = ft(e.get("test"), t);
    return t.confident ? ft(r ? e.get("consequent") : e.get("alternate"), t) : void 0;
  }
  if (e.isExpressionWrapper())
    return ft(e.get("expression"), t);
  if (e.isMemberExpression() && !e.parentPath.isCallExpression({
    ...
    if (i.isLiteral()) {
      ...
      let a = null;
      if (e.node.computed) {
        if (a = ft(r, t), !t.confident) return;
  ...
  if (e.isLogicalExpression()) {
    const r = t.confident, i = ft(e.get("left"), t), s = t.confident;
    t.confident = r;
    const n = ft(e.get("right"), t), a = t.confident;
    switch (e.node.operator) {
      case "||":
  ...
  if (e.isBinaryExpression()) {
    const r = ft(e.get("left"), t);
    if (!t.confident) return;
    const i = ft(e.get("right"), t);
    if (!t.confident) return;
    switch (e.node.operator) {
      case "-":
        return r - i;
  ...
  if (e.isCallExpression()) {
    ...
    if (s) {
      const n = e.get("arguments").map((a) => ft(a, t));
...
try {
  return (0, pB.parse)(e, t);
} catch (s) {
  const n = s.loc;
  throw n && (s.message += `
` + (0, fB.codeFrameColumns)(e, {
    start: n
...
return Object.assign((n, ...a) => {
  if (typeof n == "string") {
    ...
    return fp(e, (0, wt.merge)(s, (0, wt.validate)(n)));
  }
...
if ((t3(t) || e3(t, {
  ...
  return;
let a;
if (i && fu(i) ? a = p3(i) : i && pu(i) && (a = i.name), a === void 0 || !n && dp(e) && /[\uD800-\uDFFF]/.test(a))
  return;
a = a3(a);
const o = GB(a);
o[cu] = !0;
...
return this.node.computed || b3(e) && (e = yp(e.name)), e;
}
function D3() {
...
const r = [];
let i = "body", s, n;
e.isStatement() ? (n = "body", s = 0, r.push(e.node)) : (i += ".body.0", this.isFunction() ? (s = "argument", r.push(I3(e.node))) : (s = "expression", r.push(mp(e.node)))), this.node.body = T3(r);
const a = this.get(i);
...
if (s.ensureBlock(), M3(s, "FunctionExpression"), !r) {
  ...
  return n && s.parentPath.scope.push({
    id: n,
    init: A3([])
  }), s.get("body").unshiftContainer("body", mp(Er(this.hub.addHelper("newArrowCheck"), [Qr(), Ye(n ? n.name : i)]))), s.replaceWith(Er(vt((0, y3.default)(this, !0) || s.node, Ye("bind")), [n ? Ye(n.name) : Qr()])), s.get("callee.object");
}
return s;
}
const F3 = (0, Xa.merge)([{
...
if (l.length > 0) {
  const h = Zr(n, "arguments", () => {
    ...
    return n.scope.path.isProgram() ? g3(jn("===", _3("typeof", y()), yp("undefined")), n.scope.buildUndefinedNode(), y()) : y();
  });
  l.forEach((y) => {
    const b = Ye(h);
...
let f;
return (o.length > 0 || !t) && (f = $3(n, a), (t || a && gp(n)) && (o.forEach((h) => {
  const y = h.isJSX() ? S3(f) : Ye(f);
...
function oF(e) {
return this.key !== "body" || !this.parentPath.isArrowFunctionExpression() ? !1 : this.isExpression() ? bp(e) : this.isBlockStatement() ? H3(e) : !1;
}
function lF(e) {
let t = this, r = !0;
do {
...
function uF() {
return this.parentPath.isLabeledStatement() || bp(this.container) ? !1 : X3.includes(this.key);
}
function cF(e, t) {
...
var e = Oe, t = cI, r = Us(), i = rc(), s = Ae(), n = s, a = nt, o = vs, l = Pt, u = Zt, c = pp(), p = Bs, f = hr, h = Qe, y = Kc(), b = Ca(), A = qc(), I = SF(), _ = yi, j = et;
const {
  validate: G
} = s, ce = t("babel");
xt.REMOVED = 1, xt.SHOULD_STOP = 2, xt.SHOULD_SKIP = 4;
const te = xt.default = class Pp {
  constructor(Y, re) {
  ...
  static get({
    ...
    let B = F.get(k);
    return B || (B = new Pp(Y, W), k && F.set(k, B)), B.setup(re, Q, U, L), B;
  }
  getScope(Y) {
  ...
  evaluate: p.evaluate,
  toComputedKey: f.toComputedKey,
  ensureBlock: f.ensureBlock,
  unwrapFunctionEnvironment: f.unwrapFunctionEnvironment,
  arrowFunctionToExpression: f.arrowFunctionToExpression,
...
function i(s, n, a, o, l, u, c) {
  const p = r[s.type];
  if (!p) return !1;
  const f = new e.default(a, n, o, l);
  if (c)
    return u != null && u[l.parentKey] ? !1 : f.visitQueue([l]);
  for (const h of p)
    if (!(u != null && u[h]) && f.visit(s, h))
      return !0;
  return !1;
}
return Ui;
...
return Eu || (Eu = 1, function(e) {
  ...
  e.default = p, p.visitors = t, p.verify = t.verify, p.explode = t.explode, p.cheap = function(h, y) {
    c(h, y);
  }, p.node = function(h, y, b, A, I, _) {
    (0, s.traverseNode)(h, y, b, A, I, _);
  }, p.clearNode = function(h, y) {
    u(h, y);
  }, p.removeProperties = function(h, y) {
    return c(h, p.clearNode, y), h;
  };
  function f(h, y) {
    h.node.type === y.type && (y.has = !0, h.stop());
  }
  p.hasType = function(h, y, b) {
...
var xp = Ae();
const DF = /* @__PURE__ */ Au(xp), LF = /* @__PURE__ */ Ld({
__proto__: null,
default: DF
}, [xp]);
var or = "_$", Ke = LF;
...
var Cp = /* @__PURE__ */ new Set(["push", "pop", "unshift", "shift", "splice", "sort", "reverse"]);
function UF(e) {
if (e.type !== "MemberExpression") return !1;
...
var KF = /* @__PURE__ */ new Set(["useState", "useEffect", "useCallback", "useMemo", "useRef", "useContext"]), qF = /* @__PURE__ */ function() {
function e(t, r) {
...
return vu(e, [{
      ...
      i.type === "BlockStatement" && i.body.forEach(function(s) {
        if (s.type === "VariableDeclaration") {
          ...
          n.forEach(function(a, o) {
            if (!vp(a.init)) {
              var l = a.id.name, u = r.path.scope.getBinding(l), c = a.init;
              if (!(!u || !c)) {
                if (c.type === "CallExpression") {
                  var p = c.callee.name;
                  if (KF.has(p) && VF(r.path, p, "react"))
                    return;
                }
                var f = {
                  isModified: !1,
                ...
                u.referencePaths.forEach(function(h) {
                  r.handleReference(h, f), r.handleState(h, f);
                }), u.constantViolations.forEach(function(h) {
                  return r.handleViolation(h, f);
                }), f.isModified && f.isState && (r.parent.addImport(), f.refs.forEach(function(h) {
                  h.replaceWithSourceString("".concat(or).concat(f.name, "(").concat(h.toString(), ")"));
      ...
      if (a === "UnaryExpression") {
        ...
        if (o.callee.type === "MemberExpression") {
          ...
          if ($n(o.callee) === r.node.name) {
            if (Cp.has(u)) return !0;
            u === "map" && (i.isModified = !0);
          }
        }
        var c = Bd(o.arguments), p;
        try {
          for (c.s(); !(p = c.n()).done; ) {
            var f = p.value;
            ...
            } else if (f.type === "MemberExpression" && $n(f) === i.name)
              return i.isState = !0, !0;
          }
        } catch (h) {
          c.e(h);
  ...
  value: function(r, i) {
    if (!i.isState) {
      var s = r.findParent(function(n) {
        var a = n.type, o = n.node;
        return !!(a === "JSXExpressionContainer" || Ap(o));
      });
      s && (i.isState = !0);
    }
  }
    ...
    "FunctionDeclaration|ArrowFunctionExpression": {
      enter: function(n) {
        ...
        if (i === 0) {
          ...
          o && (r.current = r.components[n.node.start] = new qF(r, n));
        }
      },
      exit: function(n) {
        var a;
  ...
  value: function(r) {
    ...
    if (this.current && !(r.listKey !== "params" && r.key !== 0)) {
      var s = "", n = r.node.name, a = r.findParent(function(l) {
        ...
        var f = (u = p.property) === null || u === void 0 ? void 0 : u.name;
        if (f !== "map") return !1;
        var h = $n(p), y = (c = i.current) === null || c === void 0 ? void 0 : c.path.scope.getBinding(h);
        return y ? (s = h, !0) : !1;
      });
      if (a) {
        ...
        o && o.referencePaths.forEach(function(l) {
          ...
          if (u) {
            ...
            var p = l.parentPath.node;
            if (bn(p)) return;
            $r(p), l.parentPath.replaceInline(
              // @ts-ignore
              $r(Ke.callExpression(Ke.identifier("".concat(or).concat(s)), [p]))
            );
          }
        });
      }
